...
public class CreateEditOrderTest extends BaseTest {
    ...
    public void softContentOfNewOrderPage() {
        ...
        softAssert.assertEquals(AddSelectEntityPage.getTrimTitle(), titleSelectAccount);
    ...
    public void softCreateOrder() {
        ...
        OpportunityManipulationsPage.clickStage();
//        OpportunityManipulationsPage.spinWheelToTheStage(orderStage);
        OpportunityManipulationsPage.clickStage();
        OpportunityManipulationsPage.clickAccount();
...
//        OpportunityManipulationsPage.spinWheelToTheContact(contact);
        OpportunityManipulationsPage.clickContact();
        OpportunityManipulationsPage.clickNewOrderRow();
        NewOrderRowPage.clickProduct();
        AddSelectEntityPage.select(product);
...
//        OpportunityManipulationsPage.selectUser(firstUser);
        OpportunityManipulationsPage.clickUser();
        OpportunityManipulationsPage.clickStage();
//        OpportunityManipulationsPage.spinWheelToTheStage(newOrderStage);
        OpportunityManipulationsPage.clickStage();
//        OpportunityManipulationsPage.clickProbability();
//        OpportunityManipulationsPage.enterProbability("30");
        OpportunityManipulationsPage.clickCloseDate();
        OpportunityManipulationsPage.selectMonth(month);
        OpportunityManipulationsPage.selectDay(day);
        OpportunityManipulationsPage.selectYear(year);
        OpportunityManipulationsPage.clickCloseDate();
        OpportunityManipulationsPage.clickContact();
//        OpportunityManipulationsPage.spinWheelToTheContact(newContact);
        OpportunityManipulationsPage.clickContact();
        OpportunityManipulationsPage.clickCampaign();
